...
class FetchGroup {
    constructor(dependencyGraph, index, subgraphName, rootKind, parentType, isEntityFetch, _selection, _inputs, mergeAt, deferRef, subgraphAndMergeAtKey, cachedCost, isKnownUseful = false) {
    ...
    cloneShallow(newDependencyGraph) {
        var _a;
        return new FetchGroup(newDependencyGraph, this.index, this.subgraphName, this.rootKind, this.parentType, this.isEntityFetch, this._selection.clone(), (_a = this._inputs) === null || _a === void 0 ? void 0 : _a.clone(), this.mergeAt, this.deferRef, this.subgraphAndMergeAtKey, this.cachedCost, this.isKnownUseful);
    }
    cost() {
        if (!this.cachedCost) {
